...
namespace PetrolPump
{
    public partial class ReceiveLineCreditForm : Form
    {
        ...
        private void ReceiveLineCreditForm_Load(object sender, EventArgs e)
        {
            ...
            CBID.SelectedIndex = CBNumber.SelectedIndex = 0;
        ...
        private void PDocument_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            PGraphics.DrawString("Vehicle Number: " + VehicleNumber, new Font(FontName, 12), new SolidBrush(Color.Black), new PointF(X + ((MaxX - PGraphics.MeasureString("Vehicle Number: " + VehicleNumber, new Font(FontName, 12)).Width) / 2), Y + Offset));
            Offset += 25;
            PGraphics.DrawLine(DashedPen, X, Y + Offset, MaxX, Y + Offset);
            Offset += 10;
            ...
            PGraphics.DrawString("Type", new Font(FontName, 12, FontStyle.Bold), new SolidBrush(Color.Black), new PointF(150, Y + Offset));
            PGraphics.DrawString("Liter", new Font(FontName, 12, FontStyle.Bold), new SolidBrush(Color.Black), new PointF(300, Y + Offset));
            PGraphics.DrawString("Rate", new Font(FontName, 12, FontStyle.Bold), new SolidBrush(Color.Black), new PointF(375, Y + Offset));
            ...
            foreach (int Row in SelectedRows)
            {
                double TotalAmount = Convert.ToDouble(DGVReceiveLineCredit.Rows[Row].Cells[1].Value);
                double AmountReceived = Convert.ToDouble(DGVReceiveLineCredit.Rows[Row].Cells[4].Value);
                double AmountReceivable = TotalAmount - AmountReceived;
                string Type = DGVReceiveLineCredit.Rows[Row].Cells[6].Value.ToString();
                string Liter = DGVReceiveLineCredit.Rows[Row].Cells[7].Value.ToString();
                string Rate = DGVReceiveLineCredit.Rows[Row].Cells[8].Value.ToString();

                PGraphics.DrawString(DGVReceiveLineCredit.Rows[Row].Cells[9].Value.ToString(), new Font(FontName, 12), new SolidBrush(Color.Black), new PointF(5, Y + Offset));
                PGraphics.DrawString(Convert.ToDateTime(DGVReceiveLineCredit.Rows[Row].Cells[5].Value.ToString()).ToString("dd-MM-yy"), new Font(FontName, 12), new SolidBrush(Color.Black), new PointF(60, Y + Offset));
                PGraphics.DrawString(Type, new Font(FontName, 12), new SolidBrush(Color.Black), new PointF(150, Y + Offset));
                PGraphics.DrawString(Liter, new Font(FontName, 12), new SolidBrush(Color.Black), new PointF(300, Y + Offset));
                PGraphics.DrawString(Rate, new Font(FontName, 12), new SolidBrush(Color.Black), new PointF(375, Y + Offset));
            ...
            PGraphics.DrawLine(new Pen(Color.Black), new Point(295, BorderStart), new Point(295, Offset));
            PGraphics.DrawLine(new Pen(Color.Black), new Point(370, BorderStart), new Point(370, Offset));
            ...
            Offset += 10;
            PGraphics.DrawString("Total Amount: Rs " + TotalAmountReceived, new Font(FontName, 18, FontStyle.Bold), new SolidBrush(Color.Black), new PointF(X + ((MaxX - PGraphics.MeasureString("Total Amount: Rs " + TotalAmountReceived, new Font(FontName, 18, FontStyle.Bold)).Width) / 2), Y + Offset));
            Offset += 37;
            PGraphics.DrawLine(DashedPen, X, Y + Offset, MaxX, Y + Offset);
            Offset += 10;
