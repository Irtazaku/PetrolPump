...
namespace PetrolPump
{
    public partial class ReportsForm : Form
    {
        ...
        private void BtnGetLineCredit_Click(object sender, EventArgs e)
        {
            ...
            DGVReports.Columns.Add("dgvc4", "Debit");
            DGVReports.Columns.Add("dgvc5", "Credit");
            ...
            DGVReports.Rows.Add("", "", "", "Total Amount", Math.Round(TotalAmount, 2));
            DGVReports.Rows.Add("", "", "", "Amount Received", Math.Round(Received, 2));
            DGVReports.Rows.Add("", "", "", "Amount Receivable", Math.Round((TotalAmount - Received), 2));
        ...
        private void BtnGetInventory_Click(object sender, EventArgs e)
        {
            ...
            string Query = "SELECT DateTime as Date, Name, Quantity, Rate from inventoryhistory where Name like '%" + TBInventoryAddType.Text + "%' ";
        ...
        private void BtnGetCreditVehicleCash_Click(object sender, EventArgs e)
        {
            ...
            DGVReports.Columns.Add("dgvc5", "Debit");
            DGVReports.Columns.Add("dgvc6", "Credit");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (ClickedItem == 5)
            {
                ...
                Columns = new int[] { 0, 1, 2, 3, 4, 5, 6, 7, 8 };
            }
            ...
            using (ExcelPackage package = new ExcelPackage(newFile))
            {
                ...
                if (RBAll.Checked)
                    worksheet.Cells[Row, 1].Value = "Reports Period: All Records";

                if (RBDate.Checked)
                    worksheet.Cells[Row, 1].Value = "Reports Period: Specific Duration";

                if (RBToday.Checked)
                    worksheet.Cells[Row, 1].Value = "Reports Period: Today";

                if (RBLast7.Checked)
                    worksheet.Cells[Row, 1].Value = "Reports Period: Last 7 Days";

                if (RBLast15.Checked)
                    worksheet.Cells[Row, 1].Value = "Reports Period: Last 15 Days";

                if (RBLast30.Checked)
                    worksheet.Cells[Row, 1].Value = "Reports Period: Last 30 Days";
